...
Go to the [releases](https://github.com/mike-weiner/github-repo-listing/releases) section of the repository and download the `github-repo-listing.[version].zip` from the most recent release.
